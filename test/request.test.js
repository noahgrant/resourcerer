...
describe("Request", () => {
  ...
  beforeEach(() => {
    vi.spyOn(Model.prototype, "fetch").mockImplementation(function (options) {
      if (waitSuccess) {
  ...
  describe("when using the default exported function", () => {
    ...
    describe("if called successively before the model returns", () => {
      var promise, promise2, thenSpy1, thenSpy2;
 ...
 * localize our use of the vi mock clock (otherwise waitFor would also be
